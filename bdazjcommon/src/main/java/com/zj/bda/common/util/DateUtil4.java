...
public class DateUtil4 {
	 ...
	 * @return
	 */
	public static Date getAppointHourDate(Date date, int hour){
		Calendar calendar=Calendar.getInstance();
		calendar.setTime(date);
	 ...
	 * @return
	 */
	public static Date getAppointMinuteDate(Date date, int minute){
		Calendar calendar=Calendar.getInstance();
		calendar.setTime(date);
	...
	public static String setStartDateTime(String startTime) {
	...
	public static String setEndDateTime(String endTime) {
	...
	public static void main(String[] args) {
		Date appointDate = getAppointDate(new Date() ,-9);
		System.err.println(appointDate);
		String[] last12Months = new String[12];
		Calendar cal = Calendar.getInstance();
		//如果当前日期大于二月份的天数28天或者29天会导致计算月份错误，会多出一个三月份，故设置一个靠前日期解决此问题
		cal.set(Calendar.DAY_OF_MONTH, 1);
